...
import com.billy.android.preloader.util.WrapperHelper;
...
public class PreLoader {
     ...
     * @return
     */
    public static boolean listenData(int id, MultipleGroupDataListener listener, String... ids) {
        return (new WrapperHelper()).listenData(id, listener, ids);
    }
     ...
     * @return
     */
    public static boolean listenData(int id, MultiEveryInfoDataListener listener, String... ids) {
        return (new WrapperHelper()).listenData(id, listener, ids);
    }
     ...
     * @return
     */
    public static GroupedDataLoader getDataLoaderByKeyInGroup(int id, String keyInGroup) {
        return PreLoaderPool.getDefault().getDataLoaderByKeyInGroup(id, keyInGroup);
    }

    /**
     * @return success
     */
    public static boolean refresh(int id, String keyInGroup) {
        return PreLoaderPool.getDefault().refresh(id, keyInGroup);
    }
