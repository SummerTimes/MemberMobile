...
import com.klcw.app.lib.networkinterceptor.cache.CacheBlock;
import com.klcw.app.lib.networkinterceptor.cache.CacheManager;
        ...
        if (!TextUtils.isEmpty(cacheStr)) {
            ...
            if (cacheOption != null) {
                ...
                if (cacheBlock != null) {
                    ...
                    Logger.i(TAG, "cache response, cacheType is " + cacheOption.cacheType + ", expire is " + cacheOption.expire
        ...
        try {
            ...
            try {
                ...
                if (!TextUtils.isEmpty(obj)) {
                    ...
                    Logger.i(TAG, "response data str=" + jsonStr);
