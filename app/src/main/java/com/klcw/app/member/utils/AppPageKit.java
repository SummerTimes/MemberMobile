...
import com.klcw.app.member.fragment.TestFragment;
...
//            fragment = getComponentFragment("homeComponent", "getHomeFragment", "fragment");
            fragment = TestFragment.newInstance("博客");
        } else if (TextUtils.equals(tag, sPages[1])) {
//            fragment = getComponentFragment("member", "getShopFragment", "fragment");
            fragment = TestFragment.newInstance("体系");
